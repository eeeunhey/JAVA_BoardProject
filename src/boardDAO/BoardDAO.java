...
public class BoardDAO {
		// BoardDAO 게시판 관련 정보를 관리하는 클래스이다
		// 게시판에 대해 저장 , 삽입, 조회, 수정, 삭제에 관한 기능을 넣는다
		// 특정 데이터별 DAO를 패키지별로 생성해서 관리하자
		// 이렇게 기능을 넣은 후 해당하는 기능에 가서 클래스와 기능을 호출하자
	
	// 게시글 저장할 리스트를 만들자 -> 리스트를 왜쓰나 -> 입력받는 값이 안정해졌기 때문이다
	// 리스트는 가변배열이다
	// 생성자 만들었어 
